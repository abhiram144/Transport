...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Mock.controller.FunctionsController": [],
  "Mock.controller.LoginController": [],
  "Mock.controller.ProductsController": [],
  "Mock.model.LoginModel": [],
  "Mock.model.OrderedProductsModel": [],
  "Mock.model.ProductsModel": [],
  "Mock.store.OrderListStore": [],
  "Mock.store.ProductsStore": [],
  "Mock.view.AvailableProductList": [],
  "Mock.view.BuyItems": [],
  "Mock.view.Login": [],
  "Mock.view.Main": [],
  "Mock.view.OrderProducts": [],
  "Mock.view.OrderedList": [],
  "Mock.view.Picker": [],
  "Mock.view.StockManagerView": [],
  "Mock.view.UserView": []
});
